...
public class FlowlaClosePyStringImpl extends ASTWrapperPsiElement implements FlowlaClosePyString {

  public FlowlaClosePyStringImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitClosePyString(this);
  }
