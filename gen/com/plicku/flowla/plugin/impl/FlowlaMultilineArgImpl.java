...
public class FlowlaMultilineArgImpl extends ASTWrapperPsiElement implements FlowlaMultilineArg {

  public FlowlaMultilineArgImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitMultilineArg(this);
  }
  ...
  @Override
  @Nullable
  public FlowlaPyString getPyString() {
    return findChildByClass(FlowlaPyString.class);
  }
