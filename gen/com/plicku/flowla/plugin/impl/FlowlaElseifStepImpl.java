...
public class FlowlaElseifStepImpl extends ASTWrapperPsiElement implements FlowlaElseifStep {

  public FlowlaElseifStepImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitElseifStep(this);
  }
