...
public class FlowlaForwhileStepImpl extends ASTWrapperPsiElement implements FlowlaForwhileStep {

  public FlowlaForwhileStepImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitForwhileStep(this);
  }
