...
public class FlowlaStepKeywordImpl extends ASTWrapperPsiElement implements FlowlaStepKeyword {

  public FlowlaStepKeywordImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitStepKeyword(this);
  }
