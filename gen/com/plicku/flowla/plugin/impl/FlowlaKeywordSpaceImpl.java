...
public class FlowlaKeywordSpaceImpl extends ASTWrapperPsiElement implements FlowlaKeywordSpace {

  public FlowlaKeywordSpaceImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitKeywordSpace(this);
  }
