...
public class FlowlaOpenPyStringImpl extends ASTWrapperPsiElement implements FlowlaOpenPyString {

  public FlowlaOpenPyStringImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitOpenPyString(this);
  }
