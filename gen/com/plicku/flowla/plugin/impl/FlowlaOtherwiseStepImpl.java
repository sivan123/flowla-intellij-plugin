...
public class FlowlaOtherwiseStepImpl extends ASTWrapperPsiElement implements FlowlaOtherwiseStep {

  public FlowlaOtherwiseStepImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitOtherwiseStep(this);
  }
