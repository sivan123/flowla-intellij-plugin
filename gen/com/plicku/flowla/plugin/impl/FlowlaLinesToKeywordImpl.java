...
public class FlowlaLinesToKeywordImpl extends ASTWrapperPsiElement implements FlowlaLinesToKeyword {

  public FlowlaLinesToKeywordImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitLinesToKeyword(this);
  }
