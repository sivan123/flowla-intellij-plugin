...
public class FlowlaGivenStepImpl extends ASTWrapperPsiElement implements FlowlaGivenStep {

  public FlowlaGivenStepImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitGivenStep(this);
  }
