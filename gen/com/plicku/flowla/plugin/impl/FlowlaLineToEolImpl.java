...
public class FlowlaLineToEolImpl extends ASTWrapperPsiElement implements FlowlaLineToEol {

  public FlowlaLineToEolImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlowlaVisitor visitor) {
    visitor.visitLineToEol(this);
  }
